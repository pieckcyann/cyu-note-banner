...
<ToggleSetting key="adjustWidthToReadableLineWidth">
    ...
    <span slot="description">
        Adjust the banner width to only be as wide as the <em
            >readable line length</em
        >, which is used by Obsidian's <b>Readable line length</b> setting. It is
...
<InputSetting key="frontmatterField">
    ...
    <span slot="description">
        Set a prefix field name to be used for banner data in the frontmatter/<em
            >Properties</em
        >
        view.
        <br />
        For example, using <code>{frontmatterField}</code> means that banner
        data will be extracted from fields like <code>{frontmatterField}</code>,
        <code>{frontmatterField}_x</code>,
...
<ToggleSetting key="showInInternalEmbed">
    ...
    <span slot="description">
        Display the banner in the internal file embed. This is the embed that
...
<Depends on="showInInternalEmbed">
    ...
    <ToggleSetting key="enableDragInInternalEmbed">
        ...
        <span slot="description"
            >Allow banner dragging from within an internal embed</span
        >
    </ToggleSetting>
</Depends>
...
<ToggleSetting key="showInPopover">
    ...
    <span slot="description">
        Display the banner in the page preview popover. This is the preview that
        appears from the
...
<Depends on="showInPopover">
    ...
    <ToggleSetting key="enableDragInPopover">
        ...
        <span slot="description">
            Allow banner dragging from within the preview popover. This may act
...
<!-- <ToggleSetting key="enableLockButton">
    ...
    <span slot="description">
        Enable and display the lock button on the corner of a banner. When
        combined with the
        <b>Banner drag modifier key</b> setting, it might be desirable to disable
        this.
    </span>
</ToggleSetting> -->
...
<SelectSetting key="headerVerticalAlignment">
    ...
    <span slot="description">
        Align the header vertically relative to a banner, if any. If there's no
...
<ToggleSetting key="useHeaderByDefault">
    ...
    <span slot="description">
        Display a banner header without having to define a <code
            >{frontmatterField}_header</code
        >
...
<Depends on="useHeaderByDefault">
    <InputSetting key="defaultHeaderValue">
        ...
        <span slot="description">
            The default header text when the setting above is in effect for a
            given note.
            <br />
...
<InputSetting key="iconSize" numOrStr>
    ...
    <span slot="description">
        ...
        <br />
        <span
            ><em>Note:</em> this setting stacks with the <b>Header font size</b>
            setting above</span
        >
    </span>
</InputSetting>
...
<ToggleSetting key="showPreviewInLocalModal">
    ...
    <span slot="description"
        >Display a preview image of the suggested banner images</span
    >
</ToggleSetting>
<InputSetting key="localModalSuggestionLimit" type="number">
    ...
    <span slot="description">
        ...
        <br />
        <em>Note:</em> setting a high number while <b>Show preview images</b> setting
...
<InputSetting key="bannersFolder">
    ...
    <span slot="description">
        Select a folder to exclusively search for banner files in. If empty, it
...
<ToggleSetting key="autoDownloadPastedBanners">
    ...
    <span slot="description">
        If enabled, the <b>Paste banner from clipboard</b> command will
        automatically download the image from the URL into your vault and link
        it as an internal file. Great if you want to keep some banners you found
        online!
        <br />
        If you want to download them on a case-by-case basis though, you can use
        the
        <b>Download banner in note to vault</b> command for a note with a remote
        banner URL.
    </span>
</ToggleSetting>
<ButtonSetting text="Update banner sources" onClick={openLegacySourceModal}>
    ...
    <span slot="description">
        If you used Banners 1.x in the past, you may need to update the syntax
        for your banners' sources across your notes. This will help you do that
...
>
    ...
    <span slot="description">
        This plugin uses a cache to quickly return banner images, which is
        especially useful with remote images. While this cache resets whenever
        you reopen/reload Obsidian, you can flush the cache here if you're
