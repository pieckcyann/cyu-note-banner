...
// ----------------------------
export class IconFolderSelectionModal extends FuzzySuggestModal {
    constructor(app, defaultFolder, onChoose) {
        ...
        titleDiv.innerHTML = "💾 Choose a <strong>Folder</strong> to save the selected Icon in your vault";
